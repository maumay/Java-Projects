...
public final class VisualBoard extends Region
{
	...
	protected void layoutChildren()
	{
		...
		if (w > 0.01 && h > 0.01) {
			...
			Point2D backingUL = new Point2D(thin ? 0 : (w - sideLength) / 2, thin ? (h - sideLength) / 2 : 0);
			Point2D boardUL = backingUL.add(canvasLengthDifference / 2, canvasLengthDifference / 2);
