...
public final class ArrayUtils
{
	...
	/**
	 * Sequentially applies a mapping function elementwise to an finite, ordered
	 * input sequence to produce a {@linkplain Seq}.
	 *
	 ...
	 */
	public static <R> Seq<R> objMap(IntFunction<? extends R> f, int[] xs)
	{
		Flow<R> intermediate = Iter.overInts(xs).mapToObject(f);
	 ...
	 *         of the source elements with order retained.
	 */
	public static <R> Seq<R> objMap(DoubleFunction<? extends R> f, double[] xs)
	{
		Flow<R> intermediate = Iter.overDoubles(xs).mapToObject(f);
		return intermediate.toSeq();
	}
	 ...
	 *         of the source elements with order retained.
	 */
	public static <R> Seq<R> objMap(LongFunction<? extends R> f, long[] xs)
	{
