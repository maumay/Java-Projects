...
public final class IntMinMaxConsumption
{
	...
	public static <C extends Comparable<C>> OptionalInt findMin(final IntFlow source,
			final IntFunction<C> key)
	{
		int minKey = -1;
		C minVal = null;
		while (source.hasNext()) {
	...
	public static <C extends Comparable<C>> OptionalInt findMax(final IntFlow source,
			final IntFunction<C> key)
	{
		int maxKey = -1;
		C maxVal = null;
