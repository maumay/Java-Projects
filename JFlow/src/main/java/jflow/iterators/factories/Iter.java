 ...
 *
 */
package jflow.iterators.factories;
...
import jflow.iterators.impl.EmptyFlow;
...
public final class Iter
{
	 ...
	 *         of natural numbers.
	 */
	public static IntFlow intsByIndexing(IntUnaryOperator indexingFunction,
			int indexBound)
	{
		Exceptions.requireArgument(indexBound >= 0);
	 ...
	 *         range
	 */
	public static DoubleFlow doublesByIndexing(IntToDoubleFunction indexingFunction,
			int indexBound)
	{
		Exceptions.requireArgument(indexBound >= 0);
	 ...
	 *         of natural numbers.
	 */
	public static LongFlow longsByIndexing(IntToLongFunction indexingFunction,
			int indexBound)
	{
		Exceptions.requireArgument(indexBound >= 0);
